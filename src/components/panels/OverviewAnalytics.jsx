...
import {
    kpiData,
    followerGrowth,
    engagementTrends30Days,
    engagementTrends90Days,
    platformColors
} from '@/data/mockData'
...
export const OverviewAnalytics = () => {
    ...
    const kpis = [
        {
            title: 'Total Likes',
            value: kpiData.totalLikes,
            previous: kpiData.previousLikes,
            icon: Heart,
            color: 'text-pink-500',
        },
        {
            ...
            previous: kpiData.previousShares,
            icon: Share2,
            color: 'text-blue-500',
        },
        {
            ...
            previous: kpiData.previousReach,
            icon: Eye,
        ...
        <div className="space-y-3">
                            ...
                            <CardContent className="p-3">
                                <div className="flex items-start justify-between">
                                    <div className="space-y-1">
                                        ...
                                        <GrowthIndicator current={kpi.value} previous={kpi.previous} />
                                    </div>
            ...
            <Card>
                ...
                <CardContent className="p-3 pt-0">
                    <div className="grid grid-cols-3 gap-2">
                        {Object.entries(followerGrowth).map(([platform, data]) => {
